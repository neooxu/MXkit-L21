...
![下载 as](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/download_as.png)
...
![导入工程](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/import_project.png) 
...
![开始编译](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/compiler.png) 

查看编译结果，如图：表示编译成功，可以下载。

![编译完成](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/compiler_ok.png) 
...
![连接仿真器](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/device_tools.png) 
...
![进入jlink](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/into_jlink.png) 
...
![确认电压](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/jlink_assure.png) 
...
![开始下载](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/download.png) 

下载过程大约耗时 几秒钟，如下图：

![下载过程](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/download_process.png) 
...
![调试过程](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/debug_status.png) 

此时，开发者可以进行 单步调试 等操作。

若要退出调试状态，请点击工具栏 红色正方形 图标，如下图。

![退出调试](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/quit_debug.png) 
...
![IOT典型应用系统组成](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/demo_frame.png)
...
![app下载](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/app_download_address.png)  

2.使用手机号码，进行 APP 用户账号注册，验证，登录。

![app注册登录](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/app_userid.png)
...
![设备供电](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/device_power.png) 
...
![恢复出厂](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/reset_device.png)——> ![启动配网](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/net_config.png)

![身份验证](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/id_ensure.png)  ——> ![设备列表](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/device_list.png)
...
![设备监控](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/device_control.png) ——>  ![在线调试](https://github.com/neooxu/MXkit-L21/tree/master/MXkit-L21/image/app_debug.png)
